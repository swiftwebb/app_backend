...
class PaystackCallbackAPIView(APIView):
    """Paystack redirects here after payment — verifies and marks order paid."""
...
class PaystackWebhookAPIView(APIView):
    """Server-to-server webhook from Paystack for reliable confirmation."""
...
class VerifyPaymentAPIView(APIView):
    """App calls this after WebView closes to confirm payment status."""
    permission_classes = [IsAuthenticated]
